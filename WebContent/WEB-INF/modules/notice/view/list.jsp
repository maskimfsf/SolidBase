		...
		<c:forEach var="dataItem" items="${listPage.trdatas}">
			<tr target="pojo_id" rel="${dataItem.id}">
				...
				<td>
					...
					<a title="编辑${listPage.model}_${dataItem.id}" target="dialog" href="${BaseURL}${listPage.model}/${dataItem.id }/edit" rel="${listPage.model}_${dataItem.id}_edit" class="btnEdit">编辑</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
