	...
	<table class="table" width="100%" layoutH="112">
		...
		<c:forEach var="pojo" items="${listPage.pojos}">
			<tr target="pojo_id" rel="${pojo.treeMenuId}">
				<td><input id="${random}${pojo.treeMenuId}" name="ids" value="${pojo.treeMenuId}" type="checkbox"></td>
				<!--td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.treeMenuId}</td-->
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.navMenu.name}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.parent.name}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.name}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.target}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.external}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.width}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.height}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.href}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.reloadFlag}</td>
				<td onclick="selectBox('${random}${pojo.treeMenuId}')">${pojo.rel}</td>
