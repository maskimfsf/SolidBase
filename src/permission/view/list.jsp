...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${BaseURL}${listPage.model}/new" rel="${listPage.model}_new" target="dialog" width="800" height="300" title="添加"><span>添加</span></a></li>
			<li><a class="edit" href="${BaseURL}${listPage.model}/{pojo_id}/edit" rel="${listPage.model}_edit" target="dialog" width="800" height="300" warn="请选择一条记录"><span>修改</span></a></li>
		...
		<c:forEach var="dataItem" items="${listPage.trdatas}">
			<tr target="pojo_id" rel="${dataItem.id}">
				...
				<td>
					...
					<a title="编辑perm_${dataItem.id}" target="dialog" href="${BaseURL}${listPage.model}/${dataItem.id}/edit" rel="${listPage.model}_${dataItem.id}_edit" class="btnEdit">编辑</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
